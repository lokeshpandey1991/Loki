...
import com.roche.pharma.customerportal.core.models.ProductCategoryFilterModel;
...
@Model(adaptables = {
        ...
        ProductCategoryFilterModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL,
        resourceType = ProductCategoryFilterModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class ProductCategoryFilterModelImpl implements ProductCategoryFilterModel {
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/productCategoryFilter/v1/productCategoryFilter";
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.ProductCategoryFilterModel#getCategoryFilter()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.ProductCategoryFilterModel#getFilters()
     */
    @Override
