...
import com.roche.pharma.customerportal.core.models.ProductThumbnailsModel;
...
@Model(adaptables = {
        ...
        ProductThumbnailsModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL,
        resourceType = ProductThumbnailsModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class ProductThumbnailsModelImpl implements ProductThumbnailsModel {
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.ProductThumbnailsModel#getProductThumbnailsList()
     */
    @Override
