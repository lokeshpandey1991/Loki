...
import com.roche.pharma.customerportal.core.models.RelatedLinksModel;
...
@Model(adaptables = {
        ...
        RelatedLinksModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = RelatedLinksModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class RelatedLinksModelImpl implements RelatedLinksModel {
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/relatedLinks/v1/relatedLinks";
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RelatedLinksModelImpl.class);
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.RelatedLinksModel#getRelatedList()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.RelatedLinksModel#getHeadline()
     */
    @Override
    ...
    protected void postConstruct() {
        ...
        if (RELATED_LINK_TYPE_STATIC.equals(relatedLinksType)) {
            ...
            pageType = GlobalUtils.getPageTypeProperty(currentPage.getPath(), resource.getResourceResolver());
            getDynamicResults();
        }
    }
