...
import com.roche.pharma.customerportal.core.models.MetaTagModel;
...
@Model(adaptables = {
        ...
        MetaTagModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = MetaTagModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class MetaTagModelImpl implements MetaTagModel {
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/metaTag/v1/metaTag";
    ...
    protected void postConstruct() {
        ...
        pageLocale = GlobalUtils.getPageLocale(currentPage);
        ...
        if (languageModel != null && StringUtils.isNotBlank(languageModel.getSearchUrl())) {
            ...
            ssiUrl = SNP_PROXY_URL + RocheConstants.SLASH + ssiUrl + RocheConstants.SLASH
                    + (languageModel.getSearchCollection() == null ? pageLocale.toString()
                            : languageModel.getSearchCollection())
                    + RocheConstants.SLASH;
        }
    }
    
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.MetaTagModel#getShowFeaturedProduct()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.MetaTagModel#isEnableSSI()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.MetaTagModel#getSnPSSIUrl()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.MetaTagModel#getMetaDataValues()
     */
    @Override
    ...
    private void getMultiLevelTags(final Tag tag, final Map<String, String> map, final TagManager tagManager,
        ...
        if (tagIds.length >= RocheConstants.THREE) {
            final Tag childTag = getTagFromPath(
                    pimTagPath + tagIds[0] + RocheConstants.SLASH + tagIds[1] + RocheConstants.SLASH + tagIds[2],
                    tagManager);
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.MetaTagModel#getListingMeta()
     */
    @Override
                ...
                if (tag != null && tag.getPath().contains(pimTagPath)) {
                    ...
                    if (tagIds.length >= RocheConstants.THREE) {
                        ...
                        if (StringUtils.isNotBlank(ssiUrl) && !ssiUrl.contains(PRODUCTS)) {
                            ssiUrl = ssiUrl + PRODUCTS + RocheConstants.SLASH + map.get(DATA_CTD) + RocheConstants.SLASH
                                    + map.get(DATA_CTV).replaceAll(" ", "+");
                        }
