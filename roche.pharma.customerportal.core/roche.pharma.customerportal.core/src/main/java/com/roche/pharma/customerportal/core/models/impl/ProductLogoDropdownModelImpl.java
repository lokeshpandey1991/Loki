...
import com.roche.pharma.customerportal.core.models.ProductLogoDropdownModel;
...
@Model(adaptables = {
        ...
        ProductLogoDropdownModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL,
        resourceType = ProductLogoDropdownModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class ProductLogoDropdownModelImpl implements ProductLogoDropdownModel {
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/productLogoDropdown/v1/productLogoDropdown";
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProductLogoDropdownModelImpl.class);
