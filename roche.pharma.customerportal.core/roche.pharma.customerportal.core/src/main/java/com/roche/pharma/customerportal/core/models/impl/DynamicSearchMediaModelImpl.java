...
import com.roche.pharma.customerportal.core.models.DynamicSearchMediaModel;
...
@Model(adaptables = {
        ...
        DynamicSearchMediaModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL,
        resourceType = DynamicSearchMediaModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")

public class DynamicSearchMediaModelImpl implements DynamicSearchMediaModel {
    
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/dynamicsearch/v1/dynamicsearch";
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.DynamicSearchMediaModel#getDynamicMediaConfiguration()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.DynamicSearchMediaModel#getRenditionMap()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.DynamicSearchMediaModel#getImageServiceUrl()
     */
    @Override
