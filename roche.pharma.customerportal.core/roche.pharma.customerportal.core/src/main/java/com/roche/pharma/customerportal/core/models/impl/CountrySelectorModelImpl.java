...
import com.roche.pharma.customerportal.core.models.CountrySelectorModel;
...
@Model(adaptables = {
        ...
        CountrySelectorModel.class
}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = CountrySelectorModelImpl.RESOURCE_TYPE)
@Exporter(name = "jackson", extensions = "json")
public class CountrySelectorModelImpl implements CountrySelectorModel {
    
    public static final String RESOURCE_TYPE = "roche/pharma/customerportal/components/countryselector/v1/countryselector";
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getLocale()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getCountrySelectorList()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getGlobalHomePagePath()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getGlobalCountryCode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getGlobalLanguageCode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getGlobalChannel()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.roche.pharma.customerportal.core.models.impl.CountrySelectorModel#getComponentName()
     */
    @Override
    ...
    private void setGlobalChannel(final String path, final Resource resource) {
        ...
        final Page globalPage = GlobalUtils.getCurrentPage(globalResource);
